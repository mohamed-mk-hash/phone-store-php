    ...
    <nav class="nav container">
      ...
      <div class="nav__menu" id="nav-menu">
        ...
        <ul class="nav__list">
          ...
          <li class="nav__item">
            <a href="shop.php" class="nav__link active-link">Boutique</a>
          </li>
  ...
  <main class="main">
    ...
    <section class="breadcrumb">
      <ul class="breadcrumb__list ">
        ...
        <li><span class="breadcrumb__link">Boutique</span></li>
        <li><span class="breadcrumb__link">></span></li>
    ...
    <div class="products__container ">
        <div class="products__group">
            <div class="filters">
            <button class="filters-toggle-btn" id="filters-toggle-btn">Filtres</button>
                <div class="filter-menu" id="filter-menu">
                <div class="filters-header">Filtres</div>
                ...
                <div class="category-label">Trier par catégorie de téléphone</div>
                <?php
                ...
                ?>
                <div class="category-label">Trier par catégorie d'accessoires</div>
                <?php
                ...
                ?>
                <label for="price-range" class="price-label">Trier par Prix</label>
                <div class="price-range-wrapper">
                    <input type="range" id="min-price" name="min-price" min="0" max="200000" step="50" value="0">
                </div>
                <div class="price-range-display">
                    <span id="min-price-display">0 DZD</span> - <span id="max-price-display">200000 DZD</span>
                </div>
                <button id="go-button" class="price_button">trouver</button>
            </div>
        </div>
        </div>
        <div class="products__group">
    <?php
        ...
        while ($item = mysqli_fetch_assoc($all_items)) {
            if (
                (!$category_filter || $item['category_id'] == $category_filter) &&
                (!$min_price || $item['min_price'] >= $min_price) && // Updated comparison
                (!$search_term || stripos($item['name'], $search_term) !== false)
            ) {
                $filtered_items[] = $item;
            }
        }
        ...
        $paginated_items = array_slice($filtered_items, $offset, $items_per_page);
...
?>
    ...
    <div class="product__banner">
        ...
        <div class="product__actions">
            <a href="details.php?id=<?= $item['id'] ?>" class="action__btn" aria-label="voir les détails">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <form action="wishlist/add_to_wishlist.php" method="POST" style="display: inline;">
                    ...
                    <input type="hidden" name="product_price" value="<?= $newPriceFormatted ?>">
                    
                    <button type="submit" class="action__btn" aria-label="Ajouter à la liste de souhaits"">
                        <i class="fi fi-rs-heart"></i>
                    </button>
                </form>
            <?php else: ?>
                <a href="login-register.php" class="action__btn" aria-label="Ajouter à la liste de souhaits">
                    <i class="fi fi-rs-heart"></i>
                </a>
            <?php endif; ?>
        </div>
    ...
    <div class="product__content">
        ...
        <div class="product__price flex">
            ...
            echo '<p>Aucun produit trouvé avec cette recherche.</p>';
        }
        ?>
    </div>
    ...
    <div class="pagination">
        ...
        for ($i = 1; $i <= $total_pages; $i++) {
            ...
            echo '<a href="?page=' . $i . '&category_id=' . $category_filter . '" class="pagination-link ' . $active_class . '">' . $i . '</a>';
        }
        ?>
    </div>
</div>
